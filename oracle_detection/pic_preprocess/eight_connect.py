...
def use_8_connect_to_clear_img(img,p_max=10,p_min=0.1):
    ...
    for id,pos in enumerate(block_poses):
        ...
        if block_area<area_mean-area_std or block_area<50 or block_area>area_mean+area_std or d_y/d_x>p_max or d_y/d_x<p_min:
            dfs_paint(pos[0],pos[1])


    return block_poses,block_areas,labels,img
...
# plt.subplot(1,2,1)
# plt.imshow(img)
# poses,areas,labels=use_8_connect_to_clear_img(img)
# plt.subplot(1,2,2)
# plt.imshow(labels)
# plt.show()
